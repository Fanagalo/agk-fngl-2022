...
//     function () {
//         // Editor styles.
//         wp_enqueue_style('agk-fngl-2022', get_theme_file_uri('editor.css'), null, wp_get_theme()->get('Version'), 'all');
//     },
//     10
// );
...
//     'enqueue_block_editor_assets',
//     function () {
//         wp_enqueue_style('fngl-s-core-google-fonts', 'https://fonts.googleapis.com/css2?family=Merriweather+Sans:ital,wght@0,300;0,400;0,600;0,700;1,300;1,400;1,600;1,700&family=Merriweather:ital,wght@0,400;0,700;1,400;1,700&display=swap', array(), null);
//     }
// );
